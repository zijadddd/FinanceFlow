...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (accountRepository.count() == 0) {
            ...
            account1.setDefaultAccountId(defaultAccountRepository.findById(1).get());
            ...
            account2.setDefaultAccountId(defaultAccountRepository.findById(1).get());
            accountRepository.save(account2);

            Account account3 = new Account();
            account3.setFirstName("Michael");
            account3.setLastName("Brown");
            account3.setBalance(320.75);
            account3.setCurrencyCode("EUR");
            account3.setCreatedAt(LocalDateTime.now());
            account3.setDefaultAccountId(defaultAccountRepository.findById(1).get());
        ...
        if (transactionRepository.count() == 0) {
            ...
            transaction1.setAccountId(accountRepository.findById(1).get());
            ...
            transaction2.setAccountId(accountRepository.findById(1).get());
            ...
            transaction3.setAccountId(accountRepository.findById(1).get());
            ...
            transaction4.setAccountId(accountRepository.findById(2).get());
            ...
            transaction5.setAccountId(accountRepository.findById(2).get());
            ...
            transaction6.setAccountId(accountRepository.findById(3).get());
            ...
            transaction7.setAccountId(accountRepository.findById(3).get());
